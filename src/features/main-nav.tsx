...
import { SideMenuItem, SideMenu, type SideMenuItemProps, SideMenuCollapseButton } from '../components/ui/side-menu'
import { ROUTES } from '../routes/routes'
import { useState } from 'react'
import { useDevice } from '../hooks/useDevice'

type Id = Parameters<SideMenuItemProps['onClick']>[0]
...
function MainNav() {
  ...
  const onItemClick = (id: Id) => {
    navigate(id)
  }

  const getIsActive = (id: Id) => location.pathname.startsWith(id)
